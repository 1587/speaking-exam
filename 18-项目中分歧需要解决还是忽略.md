...
On the right side, two man are riding a boat on the lake.
...
secondly: Not to resolve disagreements will slow down the progress of the project,( we can not meet the deadline, which means the project will fail.)
thirdly:  Project members must have the same goal, cooperation is the key to success.
